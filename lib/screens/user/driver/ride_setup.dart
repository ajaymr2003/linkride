...
import 'ride_steps/step_2_destination.dart'; // Import the new file
            ...
            children: [
              ...
              RideStepLocation(
                ...
                onLocationSelected: (loc) {
                  setState(() => _source = loc);
                  _nextPage();
                },
              ),

              // 2. GOING TO (Using the new separate file)
              RideStepDestination(
                onLocationSelected: (loc) {
